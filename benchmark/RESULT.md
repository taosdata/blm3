# benchmark
```shell
root@vm96 /home/blm/blm3/benchmark (master)$ go test -bench=.
goos: linux
goarch: amd64
pkg: github.com/huskar-t/blm_demo/benchmark
...
```shell
root@vm96 /home/blm/blm3/benchmark (master)$ go test -bench=. -benchmem
goos: linux
goarch: amd64
pkg: github.com/huskar-t/blm_demo/benchmark
cpu: Intel(R) Core(TM) i7-10700 CPU @ 2.90GHz
